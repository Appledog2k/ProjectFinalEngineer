...
namespace ProjectFinalEngineer.Controllers
{
    ...
    public class DbManageController : Controller
    {
        ...
        public async Task<IActionResult> DeleteDatabaseAsync()
        {
            ...
            StatusMessage = success ? "Xóa cơ sở dữ liệu thành công" : "Có lỗi xảy ra khi xóa cơ sở dữ liệu";
            return RedirectToAction(nameof(ManageDatabase));
        }
        [HttpPost]
        public async Task<IActionResult> Migrate()
        {
            await _dbContext.Database.MigrateAsync();
            StatusMessage = "Cập nhật cơ sở dữ liệu thành công";
            return RedirectToAction(nameof(ManageDatabase));
        }
